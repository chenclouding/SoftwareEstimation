...
<div class="panel panel-default">
  ...
  <s:iterator id="dataFunction" value="#module.dataFunctions">
    <div class="col-md-6" style="background-color:lightcyan;">
	    ...
	    <div class="col-md-1">
	    <a id="dataFunctionEdit" onclick="" role="button" data-toggle="modal" data-target="#dataFunctionModal">
		<span class="glyphicon glyphicon-edit"></span></a>
		</div>
		<div class="col-md-1">
		<a id="dataFunctionDelete" onclick="" role="button" data-toggle="modal" data-target="#dataFunctionModal">
