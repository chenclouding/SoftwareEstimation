...
<div id="wrap">
		...
		<div id="menu">
			<ul>
				...
				<li><a href="organization!listOrganization" target="main"><span>用户管理</span></a></li>
		...
		<div id="content-wrap">			
			<div id="main">				
				<iframe frameborder="0" scrolling="no" name="main" src="organization!list"></iframe>									
			</div>
            ...
            <div id="sidebar">
					...
					<ul class="sidemenu">
						...
						<li><a href="organization!listOrganization" target="main">用户管理</a></li>
