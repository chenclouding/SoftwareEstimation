...
<div class="signup">
		...
		<p>密码：<span class="dot"> </span></p>
	 	...
	 	<a href="#userRegisterModal" role="button" class="btn btn-primary" data-toggle="modal">用户注册</a>
	 	<a href="#orgRegisterModal" role="button" class="btn btn-primary" data-toggle="modal">组织注册</a>
</div>
</form>
<div class="copyright">
	<p>北航软件所 版权所有 @2015</p>
...
<div id="userRegisterModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="orgRegisterModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
